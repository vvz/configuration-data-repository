...
class JsecTagLib {
    ...
    def userName = { attrs, body ->
        out << SecurityUtils.securityContext.getPrincipal()   
    }
    ...
    private boolean checkAuthenticated() {
        ...
        return SecurityUtils.securityContext.authenticated
    }
    ...
    private boolean checkRole(attrs) {
        ...
        // Does the user have the required role?
        return securityContext.hasRole(roleName)
    }
    ...
    private boolean checkPermission(attrs) {
        ...
        def securityContext = SecurityUtils.securityContext
        return securityContext.isPermitted(permission)
    }
}
