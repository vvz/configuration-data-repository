...
def requirementCiAuthor = "Joy Hennessy"
def requirementCiType = "Requirements"
def requirementFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Staging_purple/workspace/CDR/CDRClient_scripts/Requirements.csv"
