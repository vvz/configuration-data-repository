                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="configurationItem" action="show" id="${documentation?.parent?.id}">${documentation?.parent}</g:link></td>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${documentation.document}</td>
