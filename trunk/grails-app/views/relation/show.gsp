                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="${relation?.thisCI?.class.name.toString().toLowerCase()}" action="show" id="${relation?.thisCI?.id}">${relation?.thisCI}</g:link></td>
