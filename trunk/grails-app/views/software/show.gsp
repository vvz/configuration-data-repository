                ...
                <table>
                    <tbody>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${software.id}</td>
                        </tr>--}%
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="configurationItem" action="show" id="${software?.parent?.id}">${software?.parent}</g:link></td>
