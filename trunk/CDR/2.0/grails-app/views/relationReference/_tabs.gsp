...
<div id="main_nav">
    <ul>
        <li id="current"><g:link controller="relationReference" action="list">Relation</g:link></li>
        ...
        <li><g:link controller="documentationType" action="list">Documentation</g:link></li>
