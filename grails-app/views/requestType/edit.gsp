    ...
    <body>
        <div class="body">
            ...
            <div class="nav">
                ...
                %{--<span class="menuButton"><g:link class="list" action="list">RequestType List</g:link></span>--}%
                <span class="menuButton"><g:link class="create" action="create">New RequestType</g:link></span>
            </div>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:requestType,field:'order','errors')}'>
                                    <input type='text' id='order' name='order' value="${fieldValue(bean:requestType,field:'order')}" />
                                </td>
                            </tr> 
