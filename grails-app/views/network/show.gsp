                ...
                <table>
                    <tbody>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${network.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="configurationItem" action="show" id="${network?.parent?.id}">${network?.parent}</g:link></td>
