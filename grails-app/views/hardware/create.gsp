                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' id="description" class='value ${hasErrors(bean: hardware, field: 'description', 'errors')}'>
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean: hardware, field: 'parent', 'errors')}'>
                                    <g:select optionKey="id" from="${ConfigurationItem.list()}" name='parent.id' value="${hardware?.parent?.id}" noSelection="['null':'']"></g:select>
                                </td>
                            </tr>
