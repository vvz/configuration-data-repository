    ...
    <body>
        <div class="body">
            ...
            <div class="nav">
                ...
                %{--<span class="menuButton">
                    <g:link controller="hardware" params='["parent.id":params.id]' class="create" action="create">New Hardware</g:link>
                </span>--}%
            </div>
                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="configurationItem" action="show" id="${hardware?.parent?.id}">${hardware?.parent}</g:link></td>
                        </tr>
            ...
            <div class="buttons">
                <g:form controller="hardware">
                    ...
                    %{--<input type="hidden" name="environment.id" value="${hardware?.environment?.id}"/>--}%
