...
<html>
    <head>
        ...
        <title>Edit TestResultType</title>
    </head>
    <body>
        <div class="body">
            <h1>Edit TestResultType</h1>
            <div class="nav">
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class='prop'>
                                ...
                                <td valign='top' class='value ${hasErrors(bean:testResultType,field:'order','errors')}'>
                                    <input type='text' id='order' name='order' value="${fieldValue(bean:testResultType,field:'order')}" />
                                </td>
                            </tr> 
