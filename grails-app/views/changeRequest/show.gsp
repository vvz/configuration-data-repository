...
<html>
    <head>
        ...
        <title>Show ChangeRequest</title>
    </head>
    <body>
        <div class="body">
            <h1>Show ChangeRequest</h1>
            <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${changeRequest.id}</td>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${changeRequest.document}</td>
