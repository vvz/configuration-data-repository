...
<html>
    <head>
        ...
        <title>Show TestResult</title>
    </head>
    <body>
        <div class="body">
            <h1>Show TestResult</h1>
            <div class="nav">
                ...
                <table>
                    <tbody>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${testResult.id}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="configurationItem" action="show" id="${testResult?.parent?.id}">${testResult?.parent}</g:link></td>
                        ...
                        %{--<tr class="prop">
                            ...
                            <td valign="top" class="value">${testResult.document}</td>
