...
def testResultCiAuthor = "Jennifer Le"
def testResultCiType = "Acceptance"
def testResultFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Production_Blue/workspace/CDR/CDR/CDR/CDRClient_scripts/Test_Results.pdf"
