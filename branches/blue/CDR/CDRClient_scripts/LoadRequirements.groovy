...
def requirementCiAuthor = "Yvonne Wilson"
def requirementCiType = "Requirements"
def requirementFileAddress = "/usr/local/hudson_home/jobs/green_integration/workspace/CDR/CDR/CDRClient_scripts/Requirements.csv"
