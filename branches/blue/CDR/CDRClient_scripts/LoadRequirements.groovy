...
def requirementCiAuthor = "Donnette Orsi"
def requirementCiType = "Requirements"
def requirementFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Staging_blue/workspace/CDR/CDRClient_scripts/Requirements.csv"
