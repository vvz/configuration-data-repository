...
def requirementCiAuthor = "Sam Bledsoe"
def requirementCiType = "Requirements"
def requirementFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_STAGING_red/workspace/CDR/CDRClient_scripts/Requirements.csv"
