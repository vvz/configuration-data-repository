...
def testResultCiAuthor = "Sam Bledsoe"
def testResultCiType = "Acceptance"
def testResultFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_PRODUCTION_red/workspace/CDR/CDRClient_scripts/Test_Results.pdf"
