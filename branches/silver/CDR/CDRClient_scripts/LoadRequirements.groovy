...
def requirementCiAuthor = "Debbie"
def requirementCiType = "Requirements"
def requirementFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Staging_SILVER/workspace/CDR/CDRClient_scripts/Requirements.csv"
