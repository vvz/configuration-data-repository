...
def testResultCiAuthor = "Debbie"
def testResultCiType = "Acceptance"
def testResultFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Production_SILVER/workspace/CDR/CDRClient_scripts/Test_Results.pdf"
