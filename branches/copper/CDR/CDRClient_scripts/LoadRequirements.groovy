...
def requirementCiAuthor = "Steve Holmes"
def requirementCiType = "Requirements"
def requirementFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Staging_copper/workspace/CDR/CDRClient_scripts/Requirements.csv"
