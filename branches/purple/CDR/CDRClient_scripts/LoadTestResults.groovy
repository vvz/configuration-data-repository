...
def testResultCiAuthor = "Joy Hennessy"
def testResultCiType = "Acceptance"
def testResultFileAddress = "/usr/local/hudson_home/jobs/HDC_CDR_Production_purple/workspace/CDR/CDRClient_scripts/Test_Results.pdf"
